/**
 * @file      DAC4_0.h
 * @brief     4-bit binary-weighted DAC for the HP Display
 ...
 */
void DAC4_0_Init(void);

/**
 * Output to 4-bit DAC
 * @param data is 4-bit value to output, 0 to 15
 * @return none
 * @brief  Output to DAC4_0
 */
void DAC4_0_Out(uint32_t data);

/**
 * Converts and outputs HP to 4-bit DAC
 * @param hp is value between 0-100
 * @return none
 * @brief  Converts and outputs to DAC4_0
 */

void DAC4_0_HPOut(uint32_t hp);
